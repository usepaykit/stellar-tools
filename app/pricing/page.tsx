...
const pricingTiers = [
  {
    ...
    price: "Free forever",
    description: "Capped at 1M monthly events. The basics to get started, including up to 5 saved reports and 10K monthly session replays.",
    cta: "Sign Up",
  ...
  },
  {
    ...
    price: "Starts at $0",
    description: "1M monthly events free and $0.28 per 1K events after (volume discounts available). Unlimited reports, 20K monthly session replays free, cohorts, and more.",
    cta: "Start for Free",
  ...
  },
  {
    ...
    price: "Let's chat",
    description: "Unlimited monthly events. Advanced analytics, comprehensive data governance and security, premium support, and more.",
    cta: "Contact Sales",
    ctaVariant: "outline" as const,
  },
];
    ...
    <HeroBackground>
      <div className="bg-background min-h-screen scroll-smooth">
        ...
        <div className="text-center mb-20">
            ...
            <div className="flex -space-x-3">
              {data.map((item, i) => (
                <Image
                  ...
                  width={item.width}
                  height={item.height}
                  className="rounded-full border-2 border-background shadow-sm object-cover"
                />
              ))}
            </div>
          ...
          <h1 className="text-5xl font-bold tracking-tight sm:text-6xl lg:text-7xl mb-6 bg-linear-to-b from-foreground to-foreground/70 bg-clip-text text-transparent">
        ...
        <div className="grid gap-6 md:grid-cols-3 mb-32">
          {pricingTiers.map((tier) => (
            <Card
              key={tier.name}
              className={cn(
                "relative flex flex-col bg-white dark:bg-card",
                tier.highlighted && "border-2 border-primary/20"
              )}
            >
              <CardHeader className="pb-4">
                <CardTitle className="text-2xl font-bold mb-1">{tier.name}</CardTitle>
