...
import { TIER_FEE_TOKENS, generateResourceId, normalizeTimeSeries } from "@stellartools/web/lib";
...
export const postOrganizationAndSecret = async (
  ...
  return await runAtomic(async () => {
    ...
    const account = await createStellarAccount(defaultEnvironment);
