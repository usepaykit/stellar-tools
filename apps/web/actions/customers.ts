...
import {
  Customer,
  CustomerMetadata,
  CustomerWallet as CustomerWalletSchema,
  Network,
  ResolvedCustomer,
...
import { uploadFiles } from "@stellartools/web/integrations";
import { computeDiff, generateResourceId, mergeWithNullDeletes } from "@stellartools/web/lib";
